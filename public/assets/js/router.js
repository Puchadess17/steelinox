    ...
    updateSidebar(view) {
        document.querySelectorAll('.sidebar-item').forEach(item => {
            ...
            if (route === view ||
                ...
                (view.startsWith('project-detail') && route === 'dashboard') ||
                (view.startsWith('client-') && route === 'clients') ||
                (view.startsWith('commercial-') && route === 'commercials') ||
                (view.startsWith('user-') && route === 'users')) {
