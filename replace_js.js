...
const filePath = 'c:\\\\xampp\\\\htdocs\\\\steelinox\\\\public\\\\assets\\\\js\\\\modules\\\\project_detail_admin.js';
let content = fs.readFileSync(filePath, 'utf8');

const splitPoint = '    /** PESTAÑA: DOCUMENTOS (Mock) */';
...
const newBottom = `    /** PESTAÑA: DOCUMENTOS (Mock) */
    _renderDocumentos() {
        return \`
            <div class="space-y-6">
                <!-- Buscador -->
...
fs.writeFileSync(filePath, parts[0] + newBottom);
