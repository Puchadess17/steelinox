...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-04-2026 a las 13:52:37
...
(1, 'Empresa Demo S.L.', 'CLI-032', 1, 1, '2026-03-27 11:25:19', '2026-04-08 11:36:58', NULL),
...
ALTER TABLE `audit_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_audit_proyecto_creadod` (`project_id`,`created_at`),
...
ALTER TABLE `comments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_comments_proyecto_creadod` (`project_id`,`created_at`),
