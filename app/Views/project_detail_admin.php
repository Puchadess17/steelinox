...
<body class="bg-gray-50 antialiased">
    ...
    <header class="fixed top-0 left-0 right-0 bg-white border-b border-gray-200 z-40">
        <div class="flex items-center justify-between h-16 px-4 lg:px-6">
            ...
            <!-- BUSCADOR GLOBAL (Wireframe) -->
            <div class="hidden lg:flex flex-1 max-w-md mx-8 relative">
                <svg class="w-4 h-4 text-gray-400 absolute left-3 top-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                <input type="text" placeholder="Search projects, documents, or clients..." class="w-full bg-gray-50 border border-transparent placeholder-gray-400 text-sm rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500/10 focus:bg-white transition-all">
            </div>
