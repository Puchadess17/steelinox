        ...
        <div class="flex items-center justify-between h-16 px-4 lg:px-6">
            ...
            <div class="hidden md:block flex-1 max-w-md mx-8">
                <div class="relative">
                    ...
                    <input type="text" id="global-search" placeholder="Search projects, documents, or clients..." class="w-full pl-9 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all">
                </div>
            </div>
