    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-4">
        ...
        <div class="w-full max-w-md bg-white rounded-2xl shadow-xl shadow-gray-200/50 overflow-hidden">
            <div class="p-8">
                ...
                <!-- Error general -->
                <div id="login-error" class="hidden mb-4 px-4 py-3 bg-red-50 border border-red-200 text-red-700 rounded-lg text-sm"></div>
            ...
            <div class="border-t border-gray-100 px-8 py-4 bg-gray-50/50 text-center">
                <a href="#" class="text-sm text-orange-500 hover:text-orange-600 font-medium">¿Olvidaste tu contraseña?</a>
            </div>
        </div>
        ...
        <div class="mt-8 text-center">
            ...
            <div class="flex items-center justify-center gap-3 mt-2">
                <a href="#" class="text-xs text-orange-500 hover:text-orange-600">Soporte Técnico</a>
                <span class="text-xs text-gray-300">|</span>
                <a href="#" class="text-xs text-orange-500 hover:text-orange-600">Política de Seguridad</a>
            </div>
        </div>
    </div>
