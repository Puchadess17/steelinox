...
<head>
    ...
    <title>Steel Inox Extranet — Reestablecer Contraseña</title>
    <!-- Fonts -->
            ...
            <div class="p-8">
                ...
                <form id="reset-password-form" novalidate>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="user-email" value="<?php echo htmlspecialchars($user['email']); ?>"
                            disabled
                            class="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-sm text-gray-400">
                    </div>

                    <div class="mb-4">
                        <label for="password" class="block text-sm font-medium text-gray-700 mb-1.5">Nueva
                            Contraseña</label>
                        <div class="relative">
                            <input type="password" id="password" name="password"
                                ...
                                class="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all"
                                required>
                            <button type="button" onclick="SIApp.togglePasswordVisibility(this)"
                    ...
                    <div class="mb-6">
                        <label for="confirm-password" class="block text-sm font-medium text-gray-700 mb-1.5">Confirmar
                            Contraseña</label>
                        <div class="relative">
                    ...
                    <button type="submit" id="btn-reset"
                        class="w-full py-3 bg-orange-500 hover:bg-orange-600 text-white rounded-xl font-semibold transition-all">
                        Cambiar Contraseña
                    </button>
                </form>
                ...
                <div id="reset-success" class="hidden text-center">
                    ...
                    <a href="/steelinox/"
                        class="inline-block py-3 px-8 bg-orange-500 text-white rounded-xl font-bold text-sm">Ir al
                        Login</a>
                </div>
            </div>
        </div>
